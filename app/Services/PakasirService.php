...
class PakasirService
{
    ...
    public static function sendCustomerInvoiceWa(Order $order): void
    {
        $msg = "TAGIHAN RESMI DAN KONFIRMASI PESANAN\n"
            ...
            . "Terima kasih atas kepercayaan Anda memilih JuangDev sebagai mitra pengembangan proyek digital Anda.\n\n"
            . "Berikut adalah rincian tagihan resmi pesanan proyek Anda:\n"
            ...
            . "Jumlah Tagihan DP (50%): " . $order->formatted_dp . "\n\n"
            . "Tautan Resmi Tagihan dan Pelunasan Pembayaran:\n"
            . $order->invoice_url . "\n\n"
            . "Pembayaran Uang Muka (DP 50%) maupun Pelunasan dapat dilakukan secara otomatis melalui tautan resmi di atas.\n\n"
            . "Hormat kami,\n"
    ...
    public static function sendAdminNewOrderWa(Order $order): void
    {
        ...
        $msg = "PEMBERITAHUAN PESANAN PROYEK BARU\n"
            ...
            . "Total Nilai Proyek: " . $order->formatted_total . "\n"
            . "Jumlah Tagihan DP: " . $order->formatted_dp . "\n\n"
    ...
    public static function sendCustomerPaymentSuccessWa(Order $order, string $paymentType = 'dp'): void
    {
        if ($paymentType === 'dp') {
            $msg = "KONFIRMASI PEMBAYARAN UANG MUKA (DP 50%)\n"
                . "JuangDev Digital Solutions\n\n"
                . "Kepada Yth. Bapak/Ibu " . $order->customer_name . ",\n\n"
                . "Dengan ini kami konfirmasikan bahwa pembayaran Uang Muka (DP 50%) untuk tagihan nomor " . $order->invoice_number . " telah berhasil diterima dan diverifikasi oleh sistem.\n\n"
                . "Rincian Pembayaran:\n"
                . "Nama Proyek: " . ($order->project_name ?? $order->service_name) . "\n"
                ...
                . $order->invoice_url . "\n\n"
                . "Tim teknis JuangDev telah memulai pengerjaan proyek Anda. Terima kasih atas kepercayaan Anda.\n\n"
                . "Hormat kami,\n"
                . "Tim Manajemen JuangDev";
        } else {
            $msg = "KONFIRMASI PELUNASAN DAN SERAH TERIMA PROYEK\n"
                . "JuangDev Digital Solutions\n\n"
                . "Kepada Yth. Bapak/Ibu " . $order->customer_name . ",\n\n"
                . "Dengan ini kami konfirmasikan bahwa pembayaran pelunasan untuk tagihan nomor " . $order->invoice_number . " (Proyek: " . ($order->project_name ?? $order->service_name) . ") telah berhasil diterima secara penuh.\n\n"
                . "Status Pembayaran: LUNAS 100%\n"
                . "Total Pembayaran: " . $order->formatted_total . "\n\n"
                . "Seluruh berkas, berkas proyek, dan akses akun dapat Anda lihat melalui halaman resmi berikut:\n"
                . $order->invoice_url . "\n\n"
