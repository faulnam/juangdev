...
const categories = ["Semua", "Landing Page", "Company Profile", "E-Commerce", "Web App", "Custome Web"];

// A list of predefined colors
const colors = ["bg-blue-600", "bg-purple-600", "bg-orange-600", "bg-rose-700", "bg-emerald-700", "bg-cyan-700"];

export function PortfolioGrid({ initialData = [] }: { initialData?: PortfolioItem[] }) {
          ...
          {filteredData.map((project, i) => (
            <ScrollReveal key={i} delay={i * 0.1}>
              <div className="bg-white rounded-3xl overflow-hidden shadow-xl shadow-slate-200/50 border-2 border-slate-200 border-b-[8px] border-b-slate-300 flex flex-col h-full group hover:-translate-y-2 transition-transform duration-300">
                ...
                {project.imageUrl ? (
                  <div className="w-full h-60 relative flex items-center justify-center overflow-hidden bg-slate-100 border-b border-slate-200">
                  ...
                  <div className={`w-full h-60 ${colors[i % colors.length]} relative flex items-end justify-center p-6 overflow-hidden`}>
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto">
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.techs && project.techs.split(',').map((tag, idx) => (
                    ...
                    {project.link ? (
                      <a href={project.link} target="_blank" rel="noreferrer" className="text-[#2563EB] text-sm font-bold flex items-center gap-1 group-hover:gap-2 transition-all">
