...
const pricingData: Record<string, Plan[]> = {
  "Landing Page": [
    { name: "Starter", price: "99k", description: "Sempurna untuk validasi ide & produk tunggal", popular: false, features: ["1 Halaman Landing Page", "Desain Template Premium", "Mobile Responsive", "Tombol WhatsApp", "Waktu Pengerjaan 2 Hari"] },
    { name: "Growth", price: "299k", description: "Pilihan terbaik untuk konversi marketing", popular: true, features: ["Desain UI/UX Custom", "Copywriting Persuasif", "Integrasi Google Analytics", "Setup Domain & Hosting", "Waktu Pengerjaan 5 Hari"] },
    { name: "Scale", price: "499k", description: "Desain kompleks dengan animasi interaktif", popular: false, features: ["Animasi Interaktif (GSAP)", "A/B Testing Setup", "Integrasi Email Marketing", "Prioritas Support", "Waktu Pengerjaan 7 Hari"] }
  ],
  "Company Profile": [
    { name: "Basic", price: "199k", description: "Profil bisnis profesional & elegan", popular: false, features: ["Maksimal 3 Halaman", "Desain Responsif", "Form Kontak", "Galeri Foto", "Waktu Pengerjaan 3 Hari"] },
    { name: "Professional", price: "499k", description: "Tampil meyakinkan di mata klien", popular: true, features: ["Hingga 7 Halaman", "Desain UI/UX Custom", "CMS untuk Update Konten", "SEO Basic Setup", "Waktu Pengerjaan 7 Hari"] },
    { name: "Corporate", price: "899k", description: "Untuk perusahaan berskala besar", popular: false, features: ["Halaman Tak Terbatas", "Multi-bahasa (Bilingual)", "Portal Karir", "Integrasi Sistem Internal", "Waktu Pengerjaan 14 Hari"] }
  ],
  "E-Commerce": [
    { name: "Basic Store", price: "399k", description: "Mulai jualan online dengan cepat", popular: false, features: ["Katalog hingga 50 Produk", "Keranjang Belanja", "Integrasi WhatsApp Checkout", "Desain Mobile Friendly"] },
    { name: "Pro Store", price: "799k", description: "Toko online otomatis & scalable", popular: true, features: ["Produk Tak Terbatas", "Payment Gateway Integrasi", "Perhitungan Ongkir Otomatis", "Manajemen Inventaris", "Dashboard Analitik"] },
    { name: "Marketplace", price: "999k", description: "Sistem toko online kompleks & custom", popular: false, features: ["Multi-vendor Setup", "Sistem Poin/Diskon", "Integrasi POS Internal", "Aplikasi Mobile WebView", "Dukungan Prioritas 24/7"] }
  ],
  "Sistem Informasi": [
    { name: "Basic App", price: "499k", description: "Aplikasi web internal sederhana", popular: false, features: ["Modul Login/Register", "CRUD Data Basic", "Export PDF/Excel", "Database Setup"] },
    { name: "Pro App", price: "899k", description: "Sistem operasional lengkap & aman", popular: true, features: ["Multi-role Akses (Admin/User)", "Dashboard Analitik", "Notifikasi Email/WA", "API Integration", "Setup Cloud Server"] },
    { name: "Enterprise App", price: "999k+", description: "Sistem ERP/CRM skala perusahaan", popular: false, features: ["Modul Tak Terbatas", "Arsitektur Microservices", "Keamanan Tingkat Tinggi", "SLA Guarantee 99.9%", "Maintenance 6 Bulan"] }
  ],
  "Custom Web App": [
    { name: "Starter", price: "999k", description: "Aplikasi web fungsional untuk bisnis", popular: false, features: ["Aplikasi React/Next.js", "Desain UI/UX Custom", "API Integration", "Basic Admin Panel"] },
    { name: "Pro", price: "1.499k", description: "Aplikasi kompleks dengan sistem canggih", popular: true, features: ["Sistem Autentikasi Kompleks", "Realtime Features", "Dashboard Analytics", "Cloud Server Setup"] },
    { name: "Enterprise", price: "2.999k", description: "Solusi enterprise berskala besar", popular: false, features: ["Arsitektur Skalabel", "SLA Guarantee 99.9%", "Prioritas Support", "Maintenance Mingguan"] }
  ]
};
