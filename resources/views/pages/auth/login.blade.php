...
@section('title', 'Masuk Akun Pelanggan — JuangDev')
@section('meta_description', 'Masuk ke akun JuangDev Anda untuk memantau detail pesanan, progres pengerjaan website, dan tagihan invoice resmi.')
...
<div class="min-h-[85vh] flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8 bg-[#0B1126] relative overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-md bg-white rounded-3xl shadow-2xl border border-slate-100/90 overflow-hidden">
        ...
        <div class="relative bg-[#0A1E5E] text-white p-7 text-center overflow-hidden">
            ...
            <h2 class="relative z-10 text-xl font-black tracking-tight text-white mt-2">Masuk ke Akun Pelanggan</h2>
            <p class="relative z-10 text-xs text-white/70 font-medium mt-1">Akses pesanan, detail proyek, dan invoice resmi Anda</p>
        </div>

        <div class="p-7 sm:p-8 space-y-5">
            
            @if(session('success'))
                <div class="bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-2xl p-3.5 text-xs font-medium flex items-center gap-2">
            ...
            <form action="{{ route('login.submit') }}" method="POST" class="space-y-4">
                ...
                <div class="flex items-center justify-between pt-1">
                    <label class="flex items-center gap-2 cursor-pointer select-none">
                        <input type="checkbox" name="remember" checked class="w-4 h-4 rounded text-[#2563EB] focus:ring-[#2563EB]/20 border-slate-300">
                ...
                <button 
                    type="submit" 
                    class="w-full py-3.5 px-4 rounded-2xl bg-[#0A1E5E] hover:bg-[#122d78] text-white text-xs sm:text-sm font-bold shadow-md shadow-[#0A1E5E]/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                >
                ...
                <div class="text-center pt-3">
                    <p class="text-xs text-slate-500 font-medium">
                        Belum punya akun? 
                        <a href="{{ route('register') }}" class="font-bold text-[#2563EB] hover:underline ml-1">
                            Daftar Gratis
                        </a>
                    </p>
                </div>
